...
/// Mangayomi-faithful Cheerio/pseudom pseudo-class handlers.
///
/// Source: `mangayomi/lib/utils/extensions/dom_extensions.dart` — ported
/// verbatim so JS extensions that use `:contains`, `:has`, `:nth-child`, etc.
/// work the same way as in mangayomi (package:html querySelector alone throws
/// `UnimplementedError` for those).
