...
/// resolution.
///
/// Faithful copy of mangayomi's [coverProvider] (lib/utils/cached_network.dart).
...
/// Faithful copy of mangayomi's [cachedNetworkImage] for full-resolution
/// display sites (hero covers, tracker banners, recommendations). Wraps the
/// provider in [ExtendedImage] so [LoadState] / progress / failure can be
/// rendered uniformly.
...
/// Faithful copy of mangayomi's [cachedCompressedNetworkImage]. Same as
/// [cachedNetworkImage] but wraps the provider in [ExtendedResizeImage] so a
/// tiny resolution ceiling (default 5 KB) is enforced at decode time. Used by
/// mangayomi for low-resolution artwork that needs aggressive subsampling
/// (e.g. small tracker thumbnails).
