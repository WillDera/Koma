...
class ReaderSettingsNotifier extends Notifier<ReaderSettings> {
  ...
  void setReadingMode(ReadingMode mode) => update(state.copyWithReadingMode(mode));
  void setRotationMode(RotationMode mode) => update(state.copyWithRotationMode(mode));
